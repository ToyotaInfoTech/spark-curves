...
@DoNotDiscover
class ContinuousFrechetDistanceSuite extends SparkSqlFuncSuite {
  override val funcName: String = ContinuousFrechetDistance.prettyName
  implicit val doubleEquality: Equality[Double] = TolerantNumerics.tolerantDoubleEquality(0.001)

  test(ContinuousFrechetDistance.prettyName) {
    sqlOneRowTest(
      2.0,
...
@DoNotDiscover
class ContinuousFrechetDistanceMatchSuite extends SparkSqlFuncSuite {
  override val funcName: String = ContinuousFrechetDistanceMatch.prettyName
  implicit val doubleEquality: Equality[Double] = TolerantNumerics.tolerantDoubleEquality(0.001)
